                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr v-for="member in datas">
                                    <td>@{{ member.DT_RowIndex }}</td>
                                    <td>@{{ member.name }}</td>
                                    <td>@{{ member.gender }}</td>
                                    ...
                                    <td class="text-center">
                                        <button @click="editData(member)" class="btn btn-sm btn-warning">Edit</button>
                                        <button @click="deleteData(member.id)" class="btn btn-sm btn-danger">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
